...
function onlineSorting() {
    ...
    var groups = { "Regular": [], "L33T": [], "UB3R": [], "R00T": [], "Sociopaths": [], "Vendor": [], "Divined": [], "Custom Groups": [], "Banned": [], "Staff": [], "Closed": [], "Other": [] };
...
function rgb2group(rgb) {
    ...
    else if (rgb == "rgb(45, 126, 82)") {
        return "Vendor"; // weird green shit
    }
